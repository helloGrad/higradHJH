 ...
 */
	...
	{
		var naver_id_login = document.getElementById('naver_id_login2');
		...
		else 
		{
			...
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor' style='text-decoration: none;'>" +
			" <button id='naverLogin' class='btn btn-block btn-social' style='color: white'> " +
    		" <span id='naverLogo' class='fa'></span>Naver 아이디로 로그인</button>" +
							"</a> ";
